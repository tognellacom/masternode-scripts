...
function download_node() {
  ...
  unzip Linux.zip
  chmod +x Linux/bin/*
  mv Linux/bin/transcendence-cli $COIN_PATH && mv Linux/bin/transcendenced $COIN_PATH
  cd - >/dev/null 2>&1
...
daemon=1
port=$COIN_PORT
addnode=159.69.33.146
addnode=95.216.152.134
addnode=54.37.226.201
addnode=159.69.33.171
addnode=77.55.218.2
addnode=77.55.223.145
addnode=77.55.222.249
addnode=77.55.223.0
EOF
}
